...
The Premium promo-code outreach CRM now lives in [`marketing-outreach/`](../../../marketing-outreach/) and is documented in [outreach-crm.md](outreach-crm.md). Use it when distributing the 500 Premium promo codes to micro-creators, iOS reviewers, and feedback candidates. It replaces ad hoc spreadsheets for this specific workflow: import manually found prospects, score them, assign unique codes, generate localized drafts, export daily contact plans, and record replies. It remains human-reviewed and never sends messages automatically.
