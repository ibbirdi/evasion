...
enum L10n {
    ...
    enum Compose {
        ...
        static let promptPlaceholder = LocalizedStringResource("compose.prompt.placeholder", defaultValue: "Travel cocoon, deep work, rain for reading...", bundle: .main, comment: "Placeholder for the local ambience prompt.")
        static let suggestionHotelTitle = LocalizedStringResource("compose.suggestion.hotel.title", defaultValue: "Travel cocoon", bundle: .main, comment: "Composer prompt suggestion chip for a calming hotel and transport soundscape.")
        static let suggestionHotelPrompt = LocalizedStringResource("compose.suggestion.hotel.prompt", defaultValue: "Travel cocoon, steady travel cover, no sharp sounds", bundle: .main, comment: "Prompt inserted by the travel cocoon composer suggestion.")
